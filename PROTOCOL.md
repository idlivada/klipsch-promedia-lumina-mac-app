...
| `fea` | Brightness | 2 bytes `[pct, pct]` 0–100, written identical. **Works in ALL modes including Static** — the handoff doc's claim that it has no effect in Static is WRONG (disproven 2026-07-17: phone-app Static dimming changes only fea, `6464`↔`1e1e`, dumps 05/06). | D+W+L |
